...
const CreateUserAddressService = async (user, payload, lang) => {
  ...
  [err, userAddress] = await to(UserAddressRepository.createOne(user.id, {
    ...payload,
  }));
  if (err) {
    return Promise.reject({
...
module.exports = CreateUserAddressService;
